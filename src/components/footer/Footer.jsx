...
import { faXTwitter, faInstagram, faWizardsOfTheCoast } from '@fortawesome/free-brands-svg-icons'
function Footer() {
  return (
      ...
      <div className="footer-container">
        <div className="footer-row">
          ...
          <div className="footer-col">
            <h4>SHOP</h4>
            <ul className="footer-ul">
              <li className="footer-content"><a href="/buy">Buy</a></li>
              <li className="footer-content"><a href="/sell">Sell</a></li>
